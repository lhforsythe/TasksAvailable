...
#### Below is a video which shows how to add the exstention to Chrome, as this is not currently on the Chrome Web Store, and I am unsure if it would be against company policy to add it there:
https://github.com/user-attachments/assets/63a9747f-8617-4f58-af26-2f8c1925cbc8
